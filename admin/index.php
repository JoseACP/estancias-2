        ...
        <tbody>
              ...
              ?>
                  <tr>
                      ...
                      <th><a href="tacos/actualizar.php?id=<?php echo $row['id'] ?>" class="info">Editar</a></th>
                      <th><a href="tacos/delete.php?id=<?php echo $row['id'] ?>" class="danger">Eliminar</a></th>                                        
                  </tr>
              <?php 
                  }
              ?> 
              <a href="tacos/datos.php" class="insert">Agregar nuevo registro</a>
      </tbody> 
